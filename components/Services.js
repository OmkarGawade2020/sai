                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="xl:w-1/4 md:w-1/2 p-4">
                            <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                                <img className="h-40 rounded w-full object-cover object-center mb-6" src="https://s42814.pcdn.co/wp-content/uploads/2021/10/Fence_iStock_1225688784-scaled.jpg.optimal.jpg" alt="content" />
                        ...
                        <div className="xl:w-1/4 md:w-1/2 p-4">
                            <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                                <img className="h-40 rounded w-full object-cover object-center mb-6" src="https://m.media-amazon.com/images/I/51xGfXvPvEL._SY300_SX300_QL70_FMwebp_.jpg" alt="content" />
                        ...
                        <div className="xl:w-1/4 md:w-1/2 p-4">
                            <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                                <img className="h-40 rounded w-full object-cover object-center mb-6" src="https://m.media-amazon.com/images/I/21ouK1xlDSS._QL70_FMwebp_.jpg" alt="content" />
                                <h3 className="tracking-widest text-rose-400 text-xs font-medium title-font">WHOLESALE / RETAIL</h3>
