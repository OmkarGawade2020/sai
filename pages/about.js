...
const About = () => {
    return (
        <div>
            <div>
                <Head>
                    <title>Sai Industries.com - Your Daily Streamliner</title>
                ...
                {/* <header className="bg-rose-500 p-4">
                    <div className="container mx-auto text-white text-center">
                        <h1 className="text-4xl font-extrabold">SaiIndustries.com</h1>
                        <p className="text-lg">Your Daily Source for Agriculture</p>
                    </div>
                </header> */}
                ...
                <section className="relative">
                    <div className="h-fit flex items-center justify-center">
                        <img src="./banner.jpeg" alt="Slide 1" className="w-full h-auto" />
                    </div>
